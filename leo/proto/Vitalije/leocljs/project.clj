;@+leo-ver=5-thin
;@+node:vitalije.20170803134700.1: * @file project.clj
;@@language clojure
(defproject leo "0.1.0-SNAPSHOT"
  ...
  ;@+others
  ;@+node:vitalije.20170803135553.1: ** aliases
  :aliases {
      ...
      "descjop-once-prod" [
          "do"
              ...
              ["cljsbuild" "once" "prod-front"]]
      ;@+others
      ;@+node:vitalije.20170803140358.1: *3* electron packager for production
      "descjop-uberapp-osx"
          [
              "shell"
              "electron-packager" 
  ...
  ;@+node:vitalije.20170803135620.1: ** cljsbuild
  :cljsbuild {
      :builds {
          ;@+others
          ;@+node:vitalije.20170803135724.1: *3* dev-main
          :dev-main {
              :source-paths ["src"]
              :incremental true
              :jar true
              ...
              :compiler 
                {    :output-to "app/dev/js/cljsbuild-main.js"
                     ...
                     :pretty-print true
                     :output-wrapper true}}
          ;@+node:vitalije.20170803135738.1: *3* dev-front
          :dev-front {
              :source-paths ["src_front" "src_front_profile/leo_front/dev"]
              :incremental true
              :jar true
              :assert true
              :compiler {
                  ...
                  :pretty-print true
                  :output-wrapper true}}
          ;@+node:vitalije.20170803135755.1: *3* prod-main
          :prod-main {
              :source-paths ["src"]
              :incremental true
              :jar true
              ...
              :compiler {
                  ...
                  :pretty-print true
                  :output-wrapper true}}
          ;@+node:vitalije.20170803135833.1: *3* prod-front
          :prod-front {
              :source-paths ["src_front" "src_front_profile/leo_front/prod"]
              :incremental true
              :jar true
              :assert true
              :compiler {
